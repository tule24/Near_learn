...
use near_sdk::{near_bindgen, Gas, Balance, AccountId};

mod batch_action;
mod multiple_contracts;
mod similar_contracts;

const XCC_GAS: Gas = Gas(10u64.pow(13)); // 10e13yⓃ
const NO_DEPOSIT: Balance = 0;
const NO_AGRS: Vec<u8> = vec![];
...
impl Contract {
    #[init]
    #[private]
    pub fn init (hello_account: AccountId, counter_account: AccountId, guestbook_account: AccountId) -> Self {
        Self { hello_account, counter_account, guestbook_account }
    }
}